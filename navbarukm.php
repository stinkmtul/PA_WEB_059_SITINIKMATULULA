    ...
    <div class="container-sm d-flex justify-content-between align-items-center">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav mx-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link bi bi-person-circle" href="profilkomunitas.php"> Profil Komunitas</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link bi bi-envelope-at-fill" href="permintaanmasuk.php"> Permintaan bergabung</a>
                </li>
            </ul>
        </div>
        <ul class="navbar-nav">
